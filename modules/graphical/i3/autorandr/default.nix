  ...
  programs.autorandr = {
    ...
    hooks = {
      postswitch = {
        ...
        "change-background" = "${pkgs.feh}/bin/feh --bg-fill  ${pkgs.wallpapers.${globalConfig.aspects.graphical.wallpaper}}";
        "generate-lockscreen" = "betterlockscreen -u ${pkgs.wallpapers.${globalConfig.aspects.graphical.wallpaper}}";
      };
    };
    profiles = {
